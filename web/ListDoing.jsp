...
<div class="" style="float: right ">
    <div class="dropdown">
        ...
        <li><a href="ListDoingServlet?c=${c}&u=${account.username}&sub=${sub}&d=${d}&sort=1">Date</a></li>
        <li><a href="ListDoingServlet?c=${c}&u=${account.username}&sub=${sub}&d=${d}&sort=2">Ratting</a></li>
        </c:if>
</ul>
</div>
</div>-->
            ...
            <div class="row">
                ...
                <div class="col-2" style="float: right ">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="ListDoingServlet?c=0&u=${admin!=null?admin.username:account.username}&sub=1&d=0&sort=0">All</a></li>
                                <c:forEach var="o" items="${ListC}">
                                <li><a href="ListDoingServlet?c=${o.cateID}&u=${admin!=null?admin.username:account.username}&sub=${sub}&d=${d}&sort=0"> ${o.cateName} </a></li>
                                </c:forEach>
                        </ul>
                    </div>
                </div>
                <div class="col-2" style="float: right ">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="ListDoingServlet?c=${c}&u=${admin!=null?admin.username:account.username}&sub=${sub}&d=${d}&sort=1">Date</a></li>
                            <li><a href="ListDoingServlet?c=${c}&u=${admin!=null?admin.username:account.username}&sub=${sub}&d=${d}&sort=2">Ratting</a></li>
                        </ul>
                    </div>
                </div>
...
<!--            <div style="clear: both; float: left; margin-left: 10px">
                <c:if test="${sub==1}">
                    <a href="ListDoingServlet?c=0&u=${admin!=null?admin.username:account.username}&sub=2&d=0&sort=0" class="btn btn-primary pull-right"><span>Show UnSubscribe Subject</span></a>
                </c:if>
                <c:if test="${sub==2}">

                    <a href="ListDoingServlet?c=0&u=${admin!=null?admin.username:account.username}&sub=1&d=0&sort=0" class="btn btn-primary pull-right"><span>Show Subscribed Subject</span></a>
                </c:if>
                <c:if test="${d==2}">
