...
<body style="border-style: none;">
    ...
    <div class="container">
        ...
        <div>
            <form action="termadd?subjectID=${param.subjectID}" method="post">
                ...
                <div class="form-row">
                    ...
                    <div class="col-xl-2 text-center align-self-center" style="margin-top: 25px;"><a class="btn btn-danger" role="button" style="background: var(--pink);width: 140px;height: 50px;font-size: 25px;" href="SubjectDetail?subjectID=${param.subjectID}&termsort=0">Cancel</a></div>
                </div>
            </form>
        </div>
    </div>
