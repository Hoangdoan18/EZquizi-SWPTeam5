...
public class SubjectCRUDServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setCharacterEncoding("UTF-8");
            ...
            List<Subject> listAS = pdao.listQuery(category, username, search, sort);
        ...
        List<Subject> arr = pdao.getSubjectByPage(listAS, start, end);  
       
        List<Category> ListC = pdao.getCategory();
        
        request.setAttribute("num", numPage);
        request.setAttribute("ListC", ListC);
        request.setAttribute("listAS", arr);
